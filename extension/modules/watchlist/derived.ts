/**
 * The derived observe set — fence domains ∪ area-map domains.
 *
 * The manual watchlist is retired: a domain is auto-observed the moment it
 * appears in any fence or gets assigned an area. This is the pure merge;
 * `store.ts#derivedObserveDomains` is the storage-reading wrapper that feeds
 * it `fenceCache` and `areaMap`.
 *
...
/** Fence domains ∪ area-map domains, deduped. Order is not significant. */
