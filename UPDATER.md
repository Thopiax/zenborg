...
```json
{
  ...
  "platforms": {
    "darwin-x86_64": {
      ...
      "url": "https://github.com/equanimitech/zenborg/releases/download/v0.3.1/zenborg_0.3.1_x64.app.tar.gz"
    },
    "darwin-aarch64": {
      "signature": "SIGNATURE_FROM_.sig_FILE",
    ...
    "linux-x86_64": {
      "signature": "SIGNATURE_FROM_.sig_FILE",
      "url": "https://github.com/equanimitech/zenborg/releases/download/v0.3.1/zenborg_0.3.1_amd64.AppImage.tar.gz"
    },
    "windows-x86_64": {
      "signature": "SIGNATURE_FROM_.sig_FILE",
      "url": "https://github.com/equanimitech/zenborg/releases/download/v0.3.1/zenborg_0.3.1_x64-setup.nsis.zip"
    }
  }
}
```
