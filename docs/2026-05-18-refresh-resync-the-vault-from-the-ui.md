---
migrated_from: equanimi.tech/project/zenborg/dev/20260518T100328Z-vem33s.md
---
# Refresh / resync the vault from the UI

Raw capture — 2026-04-30. Promoted to zenborg:dev from `_self/inbox/triage` 2026-05-18. GTD: someday (next zenborg cycle next-action candidate).
