...
describe("MomentCreationService", () => {
  ...
  describe("createMomentWithWorkflow", () => {
    describe("Basic Creation", () => {
      ...
      it("should create moment with attitude and tags", () => {
        const result = service.createMomentWithWorkflow({
          name: "Learning React",
          areaId: "area-123",
      ...
      it("should create moment with custom metric for PUSHING attitude", () => {
        const result = service.createMomentWithWorkflow({
          name: "Run 5K",
          areaId: "area-123",
        ...
        expect(isMomentError(result)).toBe(false);
        if (!isMomentError(result)) {
          expect(result.attitude).toBe(Attitude.PUSHING);
    ...
    describe("Prefilled Allocation Workflow", () => {
      ...
      it("should allocate with attitude and tags preserved", () => {
        const result = service.createMomentWithWorkflow({
          name: "Learning",
          areaId: "area-123",
          attitude: Attitude.BEGINNING,
    ...
    describe("Business Rules", () => {
      ...
      it("should preserve customMetric when allocating with PUSHING attitude", () => {
        const result = service.createMomentWithWorkflow({
          name: "Workout",
          areaId: "area-123",
          attitude: Attitude.PUSHING,
