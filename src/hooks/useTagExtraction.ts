...
export function useTagExtraction({
  ...
  const addTag = useCallback(
    (tag: string, currentName: string, currentTags: string[]) => {
  ...
  const checkForCompletedTag = useCallback(
    (
      text: string,
      cursorPos: number,
      currentName: string,
  ...
  const extractRemainingTags = useCallback(
    (currentName: string, currentTags: string[]) => {
  ...
  const handleNameChange = useCallback(
    (newValue: string, currentName: string, currentTags: string[]) => {
      onNameChange(newValue);
